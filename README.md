# PA_HW7_8_9_10_11_12_13_14_15_16_17_18_19_django

>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<
HW19(Lectin 31, 32) 
Реализовать авторизацию с извлечением текущего пользователя из запроса и 
применение разрешений на уровне объектов. 
...
Реализуйте пользовательский пермишен для проверки, 
что пользователь является автором задачи или подзадачи.
Добавьте пермишены к представлениям для задач и подзадач, 
чтобы только владельцы могли их изменять или удалять.
